...
parrafo3.onclick = () => { // Tecnica que funciona bien para generar contenido en un html
    nuevafuncion(1);
}
...
function nuevafuncion(id) { // Tecnica que funciona bien para generar contenido en un html 2
